    ...
    <div>
      <section className="page-hero">
        <div className="section-container">
          ...
          <p className="page-hero-subtitle">We'd love to hear from you. Reach out anytime.</p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <AnimatedSection delay={0.2}>
              ...
              <div className="space-y-4">
                {offices.map((o) => (
                  <div key={o.country} className="flex items-start gap-3 p-4 bg-muted rounded-lg">
              ...
              <div className="mt-8 p-6 bg-green-light rounded-lg">
              ...
              {/* Map placeholder */}
              <div className="mt-8 bg-muted rounded-lg h-48 flex items-center justify-center border border-border">

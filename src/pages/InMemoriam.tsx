  ...
  <div>
    <section className="page-hero bg-muted">
      <div className="section-container">
        ...
        <p className="page-hero-subtitle">A tribute to the legacy that inspires our mission.</p>
      </div>
    </section>
      ...
      <div className="section-container max-w-4xl mx-auto">
        <AnimatedSection>
          <div className="text-center mb-12">
            <div className="w-48 h-48 rounded-full overflow-hidden mx-auto mb-6 border-4 border-gold/30 shadow-lg">
            ...
            <p className="text-gold font-semibold">In Honor of His Legacy</p>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.3}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <div key={v.name} className="text-center p-6 bg-muted rounded-lg">
                <v.icon className="text-gold mx-auto mb-3" size={32} />
